...
$baseURL = 'http://'.$_SERVER['SERVER_NAME'].'/outsource/';
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo "Outsource Area"; ?></title>
		<link rel="shortcut icon" href="<?php echo $icon; ?>images/logo.png" type="image/x-icon" />
		...
		<link rel="stylesheet" href="<?php echo $baseURL; ?>css/chosen.min.css" />
		<link rel="stylesheet" href="cdn.datatables.net/1.10.20/css/jquery.dataTables.min.css" />
		<link rel="stylesheet" href="<?php echo $baseURL; ?>css/ace-skins.min.css" class="ace-main-stylesheet" id="main-ace-style" />
